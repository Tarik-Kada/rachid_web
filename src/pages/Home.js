      ...
      <div className={classes.splitsection}>
        ...
        <div className={classes.half}>
          ...
          <p>
            ...
            glasvezelbedrijven van Nederland. Wij houden ons voornamelijk bezig
            met het aanleggen, ontwerpen en beheren van glasvezelnetwerken en
            verbindingen. Onze ambitie is om zoveel mogelijk huishoudens en
            gemeentes te voorzien van een razendsnelle glasvezelverbinding.
          </p>
